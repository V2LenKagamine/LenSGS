/*
 * I'm not going to lie. I stole this.
 * <https://github.com/SilentChaos512/silent-utils/blob/master/src/main/java/net/silentchaos512/utils/Color.java>
 * If you are silent, Hi, love your mod btw, kinda the inspiration for this.
...
public class Color {
    ...
    public static final Color BRONZE = named("Bronze",0xCD7F32);
    ...
    public static final Color GLOWSTONE = named("Glowstone",0x9E9E02);
    ...
    public static final Color LEAD = named("Lead",0x6C6C6A);
    ...
    public static final Color OBSIDIAN = named("Obsidian",0x2b024A);
    ...
    public static final Color OSMIUM = named("Osmium", 0x3E24D1);
    ...
    public static final Color STEEL = named("Steel",0x44444D);
    ...
    public static final Codec<Color> CODEC = RecordCodecBuilder.create(inst ->
            inst.group(
                    Codec.FLOAT.fieldOf("red").forGetter(Color::getRed),
                    Codec.FLOAT.fieldOf("green").forGetter(Color::getGreen),
                    Codec.FLOAT.fieldOf("blue").forGetter(Color::getBlue),
                    Codec.FLOAT.fieldOf("alpha").forGetter(Color::getAlpha)
            ).apply(inst,Color::new));

    public static final StreamCodec<ByteBuf,Color> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.FLOAT,Color::getRed,
            ByteBufCodecs.FLOAT,Color::getGreen,
            ByteBufCodecs.FLOAT,Color::getBlue,
            ByteBufCodecs.FLOAT,Color::getAlpha,
            Color::new
    );
