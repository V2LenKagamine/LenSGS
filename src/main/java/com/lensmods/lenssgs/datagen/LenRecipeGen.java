...
public class LenRecipeGen extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput out) {
        ...
        refillFromIng("refill_gunpowder",List.of(Ingredient.of(Tags.Items.GUNPOWDERS)),LenItems.AMMO_BASE.get(),out,5);
        refillFromIng("refill_tnt",List.of(Ingredient.of(Items.TNT)),LenItems.AMMO_BASE.get(),out,25);
        refillFromIng("refill_wind",List.of(Ingredient.of(Items.WIND_CHARGE)),LenItems.AMMO_BASE.get(),out,10);
        //Stocks
