...
public class LenMaterialGen {
    ...
    public static final List<GunMaterial> DEFAULT_MATS = List.of(
            new GunMaterial("wood",WOOD_STATS,WOOD_TRAITS,Tags.Items.RODS_WOODEN,Color.BURLYWOOD,List.of(STOCK,ROUND,SCOPE)),
            ...
            new GunMaterial("blaze",BLAZEROD_STATS,BLAZEROD_TRAITS,Tags.Items.RODS_BLAZE,Color.SUNGLOW,ROUND,BARREL,PROPELLANT,SCOPE),
            new GunMaterial("prismarine",PRISMARINE_STATS,PRISMARINE_TRAITS, Ingredient.of(Items.PRISMARINE_SHARD),Color.DARKCYAN,List.of(ROUND,SCOPE)),
            new GunMaterial("pirsmarine_gem",PRISMARINE_CRYSTAL_STATS,PRISMARINE_CRYSTAL_TRAITS,Tags.Items.GEMS_PRISMARINE,Color.LIGHTCYAN,ROUND,SCOPE),
            new GunMaterial("tnt",TNT_STATS,TNT_TRAITS,Ingredient.of(Blocks.TNT),Color.CORAL,PROPELLANT_ONLY),
            new GunMaterial("slime",SLIME_STATS,SLIME_TRAITS,Tags.Items.SLIMEBALLS,Color.LIMEGREEN,ROUND,STOCK,SCOPE),
            new GunMaterial("magma_cream",MAGMA_STATS,MAGMA_TRAITS,Ingredient.of(Items.MAGMA_CREAM),Color.ORANGERED,List.of(ROUND,STOCK,SCOPE)),
            new GunMaterial("quartz",QUARTZ_STATS,QUARTZ_TRAITS,Tags.Items.GEMS_QUARTZ,Color.WHITESMOKE,ROUND,SCOPE),
            new GunMaterial("breeze",BREEZE_ROD_STATS,BREEZE_ROD_TRAITS,Tags.Items.RODS_BREEZE,Color.LIGHTBLUE,BARREL,PROPELLANT,SCOPE),
            new GunMaterial("amethyst",AMETHYST_STATS,AMETHYST_TRAITS,Tags.Items.GEMS_AMETHYST,Color.MEDIUMPURPLE,ROUND,SCOPE),
            ...
            new GunMaterial("netherstar",NETHER_STAR_STATS,NETHER_STAR_TRAITS,Ingredient.of(Items.NETHER_STAR),Color.WHITE,List.of(ROUND,PROPELLANT,SCOPE)),
            new GunMaterial("copper_rod",COPPER_ROD_STATS,COPPER_ROD_TRAITS,Ingredient.of(Items.LIGHTNING_ROD),Color.COPPER,List.of(ROUND,SCOPE)),
